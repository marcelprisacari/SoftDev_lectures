...
const fs = require("fs"); // library pulled from node. Allows to manipulate files.
...
/* 
    syntax:
        ...
        Example URL
            ...
            - "1" would reference a parameter or fexible string.
...
/* 
    - Make a GET route
        ...
        - it will "Get All" based off /routes.
...
router.post("/", (req, res) => {
    try {
        ...
        fs.readFile("./helpers/db.json", (err, data) => {
            ...
            db.push(toDoItem); // adding our new item to our array (db.json)
            ...
            /* 
            - Requires
                - route to original file (same patway as readfile)
                - what needs to be included or written
                    - we are making our array BACK into a JSON format and stringify it.
                - Callback function to handle erros.
            */
