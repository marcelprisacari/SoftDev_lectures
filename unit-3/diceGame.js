...
let dieRoll; // a variable to hold pur roll value.
...
function rollDie() {
    // this will generate a random number and increase our roll count.
...
function playState(task) {
    ...
    if (valid.includes(task)) {
        ...
        if(stateOfDie === 'roll') {
            ...
            if(numberOfRolls === 3){
                console.log(`You've rolled ${numberOfRolls} times. This roll doesn't count!`)
            } else {
                rollDie();
